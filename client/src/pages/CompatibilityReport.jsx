...
export default function CompatibilityReport() {
  ...
  if (loading)
    return <LoadingPage>{SYMBOLS.earth} Loading report...</LoadingPage>;
  ...
  return (
    <Page>
      ...
      <Content>
        ...
        <Disclaimer>
          {SYMBOLS.star} A low score isn't a verdict — it's a user manual. The
          couples who struggle aren't the incompatible ones; they're the ones
          who don't know they're incompatible.
        </Disclaimer>
