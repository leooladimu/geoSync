...
const CustomSelectTrigger = styled.button`
  ...
  border: 1px solid
    ${(props) =>
      props.selected
        ? props.theme.colors.accent + "66"
        : props.theme.colors.border};
  border-radius: ${(props) =>
    props.isOpen
      ? `${props.theme.radius.md} ${props.theme.radius.md} 0 0`
...
const CustomOption = styled.button`
  ...
  border-left: 3px solid
    ${(props) => (props.isSelected ? props.theme.colors.accent : "transparent")};
  color: ${(props) =>
    props.isSelected
      ? props.theme.colors.accent
      : props.theme.colors.textPrimary};
  ...
  const canProceed = () => {
    if (step === 1)
      return (
        ...
        formData.birthLocation.country
      );
    if (step === 2)
      return formData.survey.openness && formData.survey.stressResponse;
    if (step === 3)
      return formData.survey.socialSeason && formData.survey.conflictStyle;
    return false;
  };
  ...
  return (
    <OnboardingContainer>
      <Header>
        ...
        <Subtitle>
          We'll use your birth data and 4 simple questions to generate your
        ...
        <StepCard>
          {step === 1 && (
            <>
              ...
              <StepDescription>
                Your date and location of birth create the foundation of your
                biological profile.
              </StepDescription>
              ...
              <ScienceCallout>
                ...
                <ScienceText>
                  Season of birth affects neurotransmitter development, while
                  latitude influences stress response patterns. This isn't
                  astrology — it's environmental imprinting.
                </ScienceText>
              </ScienceCallout>
              ...
              >
                <Field>
                  ...
                  <Input
                    ...
                    value={formData.dob}
                    onChange={(e) =>
                      updateFormData("dob", null, e.target.value)
                    }
                    required
                  />
                </Field>
                ...
                <Field>
                  ...
                  <LocationRow>
                    <Input
                      ...
                      onChange={(e) =>
                        updateFormData("birthLocation", "city", e.target.value)
                      }
                      required
                    />
                    <Input
                      ...
                      onChange={(e) =>
                        updateFormData("birthLocation", "state", e.target.value)
                      }
                    />
                    <Input
                      placeholder="Country"
          ...
          {step === 2 && (
            <>
              ...
              <StepDescription>
                How you approach people and situations reveals your underlying
                biological patterns.
              </StepDescription>
              ...
              >
                <Field>
                  ...
                  <CustomSelect
                    ...
                    onChange={(e) =>
                      updateFormData("survey", "openness", e.target.value)
                    }
                ...
                <Field>
                  ...
                  <CustomSelect
                    ...
                    onChange={(e) =>
                      updateFormData("survey", "stressResponse", e.target.value)
                    }
                    placeholder="Select your response..."
                    options={[
                      {
                        value: "freeze",
                        label: "Freeze and withdraw",
                        icon: "❄️",
                      },
                      {
                        value: "expand",
                        label: "Expand and engage",
                        icon: "🌊",
                      },
                      {
                        value: "fight-flight",
          ...
          {step === 3 && (
            <>
              ...
              <StepDescription>
                Your social and conflict patterns complete your compatibility
                blueprint.
              </StepDescription>
              ...
              <ScienceCallout>
                ...
                <ScienceText>
                  These answers help us understand your chronotype, seasonal
                  preferences, and conflict resolution style — all biologically
                  influenced patterns that affect compatibility.
                </ScienceText>
              </ScienceCallout>
              ...
              <Form onSubmit={handleSubmit}>
                <Field>
                  ...
                  <CustomSelect
                    ...
                    onChange={(e) =>
                      updateFormData("survey", "socialSeason", e.target.value)
                    }
                    placeholder="Select your season..."
                    options={[
                      {
                        value: "spring",
                        label: "Spring (new beginnings)",
                        icon: "🌸",
                      },
                      {
                        value: "summer",
                        label: "Summer (peak energy)",
                        icon: "☀️",
                      },
                      {
                        value: "fall",
                        label: "Fall (cozy connections)",
                        icon: "🍂",
                      },
                      {
                        value: "winter",
                        label: "Winter (intimate bonds)",
                        icon: "❄️",
                      },
                    ]}
                  />
                ...
                <Field>
                  ...
                  <CustomSelect
                    ...
                    onChange={(e) =>
                      updateFormData("survey", "conflictStyle", e.target.value)
                    }
                    ...
                    options={[
                      ...
                      {
                        value: "process-first",
                        label: "Process first, then resolve",
                        icon: "🧘",
                      },
                      {
                        value: "avoid",
                        label: "Avoid and let time heal",
                        icon: "🕊️",
                      },
                    ]}
                  />
